...
namespace FLYNOBORDERS.SelfB2B.Web.Controllers
{
    ...
    public class PackageController : BaseController
    {
        ...
        {
            return View(Context.PackagePictures.ToList());
        }
        ...
        [HttpPost]
        public ActionResult Create(HttpPostedFileBase file, PackagePicture emp)
        {
            ...
            Context.PackagePictures.Add(emp);
            if (Context.SaveChanges() > 0)
            {
                file.SaveAs(path);
                ViewBag.msg = "Congratulations! Package Added Successfully";
                ModelState.Clear();
            }
            return View();
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var p = Context.PackagePictures.Find(id);
        ...
        [HttpPost]
        public ActionResult Edit(HttpPostedFileBase file, PackagePicture emp)
        {
            ...
            if (file != null)
            {
                ...
                if (Context.SaveChanges() > 0)
                {
                    ...
                    ViewBag.msg = "Package Updated Successfully";
        ...
        public ActionResult Delete(int? id)
        {
            ...
            if (Context.SaveChanges() > 0)
            {
                ...
                ViewBag.msg = "Package Successfully Deleted";
                return RedirectToAction("Index");
            }
            return View(p);
        }
